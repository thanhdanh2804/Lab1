  ...
  return (
    <View style={{ flex: 1 }}>
      <View style={{ flex: 1, justifyContent: 'space-around', alignItems: 'flex-end', backgroundColor: bgColorResult }}>
        <TouchableOpacity
          style={{ marginTop: 50, marginLeft: 20, borderRadius: 90, height: 60, width: 60, justifyContent: 'center', alignItems: 'center', alignSelf: 'flex-start', backgroundColor: bgColorThemeButton }}
